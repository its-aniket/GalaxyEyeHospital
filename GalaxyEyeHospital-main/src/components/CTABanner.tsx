    ...
    <section className="py-20 bg-[hsl(var(--primary))] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 text-center relative z-10 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/eye-care-at-home" className="px-8 py-4 bg-white text-[hsl(var(--primary))] font-semibold rounded-lg hover:bg-gray-100 transition-colors shadow-lg inline-flex items-center gap-2 justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12c2.5-4.5 6.5-7 10-7s7.5 2.5 10 7c-2.5 4.5-6.5 7-10 7s-7.5-2.5-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
            Eye Care at Home
          </Link>
          <Link to="/contact" className="px-8 py-4 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/15 transition-colors shadow-lg inline-flex items-center gap-2 justify-center border border-white/20">
